...
--
-- Počítač: localhost
-- Vygenerováno: Úte 27. lis 2012, 21:37
-- Verze MySQL: 5.5.28
-- Verze PHP: 5.3.18
...
-- Databáze: `xdvora0n`
--
CREATE DATABASE `xdvora0n` DEFAULT CHARACTER SET latin2 COLLATE latin2_czech_cs;
USE `xdvora0n`;
...
INSERT INTO `akce` (`id_akce`, `vlozil`, `vlozeno_dne`, `zacatek`, `konec`, `nazev`, `podrobnosti`) VALUES
...
(30, 2, '2012-11-23 20:06:08', '2013-01-17 20:10:00', '2013-01-17 21:10:00', 'VizProsinec2012', NULL),
...
INSERT INTO `kategorie` (`id_kategorie`, `id_zamestnanec`, `nazev_kat`, `barva`, `pismo`) VALUES
...
--
-- Struktura tabulky `se_zucastni`
--

CREATE TABLE IF NOT EXISTS `se_zucastni` (
...
--
-- Vypisuji data pro tabulku `se_zucastni`
--

INSERT INTO `se_zucastni` (`id_akce`, `id_zamestnanec`, `checked`, `id_kategorie`) VALUES
(1, 2, 1, 1),
(1, 3, 0, 3),
(1, 4, 0, NULL),
(1, 5, 0, NULL),
...
INSERT INTO `zamestnanec` (`id_zamestnanec`, `id_nadrizeny`, `role`, `login`, `heslo`, `jmeno`, `prijmeni`, `email`, `telefon`) VALUES
...
--
-- Omezení pro tabulku `se_zucastni`
--
ALTER TABLE `se_zucastni`
