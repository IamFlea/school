...
try:
    ...
    sys.stderr.write("    python2 heuristic_full_circuit.py ./path/ added_cols inputs outputs [lback]\n")
    sys.stderr.write("OPTIONS\n")
    sys.stderr.write("    The directory must contain run report of cgp.\n")
    sys.stderr.write("    added_cols is a number of added cols. Must be larger than two.\n")
    sys.stderr.write("    inputs and outputs are primary I/O of new circuit\n")
    sys.stderr.write("        If they are equal the circuit is multiplier; otherwise it is an adder.\n")
    sys.stderr.write("    lback is just for feshion of outputfile.\n")
    sys.stderr.write("DESCRIPTION\n")
    sys.stderr.write("    Creates an arithmetic circuit chromosome from smaller circuit\n")
    exit(1)
try:
