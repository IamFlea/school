...
class Cgp_algorithm:
    ...
    def evolution(self):
        ...
        for i in range(0, self.__chromLength):
    ...
    def initPopulation(self):
        ...
        for i in range(0, self.popsize):
            ...
            for j in range(0, self.area):
                ...
                for k in range(0, self.maxArity):
    ...
    def __usedNodes(self, chrom):
        ...
        for i in range(0, self.inputPorts): usedNodes.append(0)
        for i in range(0, self.area): usedNodes.append(0)
        for i in range(0, self.outputPorts): 
            usedNodes[chrom[idx]] = 1
            idx += 1
        idx = self.__lastBaseIdx - 1
        uidx = len(usedNodes) - 1
        for i in range(self.column, 0, -1):
    ...
    def resultChrom(self):
        ...
        for i in range(0, self.area):
            result += "("
            for i in range(0, self.maxArity + 1):
