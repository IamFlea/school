...
class Cgp:
    ...
    #  Functions of CGP
    ############################################################################
    id   = lambda self, a, b: a
    and_ = lambda self, a, b: a & b
    or_  = lambda self, a, b: a | b
    xor  = lambda self, a, b: a ^ b
    not_ = lambda self, a, b: ~a
    nand = lambda self, a, b: ~(a & b)
    nor  = lambda self, a, b: ~(a | b)
    nxor = lambda self, a, b: ~(a ^ b)

    add  = lambda self, a, b: a + b
    sub  = lambda self, a, b: a - b
    mul  = lambda self, a, b: a * b
    div  = lambda self, a, b: a / b # if b != 0.0 else 10.0**10.0
    sin  = lambda self, a, b: sin(a) # if a != float("inf") else float("inf")
    _0_25= lambda self, a, b: 0.25
    _0_50= lambda self, a, b: 0.50
    _1_00= lambda self, a, b: 1.00
...
class Cgp:
    ...
    sin  = lambda a, b: math.sin(a) # if a != float("inf") else float("inf")
